      ...
      <div className="mx-16 p-2  grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-4  space-x-2 rounded-lg">
        {MenuData.map((menu) => {
          return (
            ...
            >
              <div className=" bg-teal-300  text-center p-2 rounded-lg ">
                <img
                  src={menu.url}
                  alt="Error"
                  className=" rounded-full max-w-24 max-h-24  mx-16 "
                />
                <p className="ms-2 my-3 p-2 text-black rounded-full float-left mb-56 ">
                  {menu.category}
